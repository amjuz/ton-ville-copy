  ...
  return (
    <div className="mt-4 p-2 sm:p-4">
      ...
      <div className="mt-5 pl-1">
        <h1 className="text-2xl font-bold">Bybit Quest</h1>
        <p className="text-muted-foreground">Valve Protocol</p>
        <p className="mt-2">
          Unlock crypto wisdom and stand to win 25 USDT each week by 3 simple steps!
        </p>
      </div>
