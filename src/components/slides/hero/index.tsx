...
export default function SlidesPage() {
  ...
  useEffect(() => {
    ...
    router.prefetch('/protected/core') // Prefetch the target page
  ...
  const skipSlides = () => {
    // TODO: Replace with '/protected/wake-up' with your desired route
    router.push('/protected/core')
  }
